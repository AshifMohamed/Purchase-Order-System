...
import purchase.order.system.SampleJinternalFrame;
...
public class ManagementHome extends javax.swing.JFrame {
    ...
    public ManagementHome() {
        ...
        lablelDamageNotification.setVisible(false);
...
//}
    ...
    public void getDamageNotification() {
        ArrayList<RequesitionItems> notficationCount = goodsReceivedDBUtils.getAllDamages();
        if (notficationCount.size() > 0) {
            lablelDamageNotification.setVisible(true);
            jLabel10.setVisible(true);
            jLabel10.setText(Integer.toString(notficationCount.size()));
        }
    }

    public void showDamagedDetail() {
        String output = "";
        for (int i = 0; i < goodsReceivedDBUtils.getAllDamages().size(); i++) {
           
            String reqNumner = "REQ"+ String.format("%03d", goodsReceivedDBUtils.getAllDamages().get(i).getRewuesitionNo());
            String itemNuber = "ITM"+ String.format("%03d", goodsReceivedDBUtils.getAllDamages().get(i).getItemNo());
            String damagedQuantity = Double.toString(goodsReceivedDBUtils.getAllDamages().get(i).getDamagedQuantity());
            output += reqNumner + " - " + itemNuber + " - "+ damagedQuantity+"\n";
        }
        JOptionPane.showMessageDialog(null, output, "DAAMGE DETAILS",
    ...
    private void initComponents() {
        ...
        lablelDamageNotification = new javax.swing.JPanel();
        ...
        lablelDamageNotification.setBackground(new java.awt.Color(204, 0, 51));
        lablelDamageNotification.setFont(new java.awt.Font("Dialog", 0, 36)); // NOI18N
        lablelDamageNotification.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                lablelDamageNotificationMouseClicked(evt);
            }
        });

        javax.swing.GroupLayout lablelDamageNotificationLayout = new javax.swing.GroupLayout(lablelDamageNotification);
        lablelDamageNotification.setLayout(lablelDamageNotificationLayout);
        lablelDamageNotificationLayout.setHorizontalGroup(
            lablelDamageNotificationLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, lablelDamageNotificationLayout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(jLabel10)
                .addGap(48, 48, 48))
        );
        lablelDamageNotificationLayout.setVerticalGroup(
            lablelDamageNotificationLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(lablelDamageNotificationLayout.createSequentialGroup()
                .addContainerGap()
        ...
        bgLayout.setHorizontalGroup(
            ...
            .addGroup(bgLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(lablelDamageNotification, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)
                ...
                .addGroup(bgLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(bgLayout.createSequentialGroup()
                        .addGroup(bgLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(bgLayout.createSequentialGroup()
                                .addContainerGap()
                                .addComponent(lablelDamageNotification, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                        .addGap(23, 23, 23)
                        .addComponent(jPanel1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                .addGap(0, 0, 0))
        );
    ...
    private void lablelDamageNotificationMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lablelDamageNotificationMouseClicked
        showDamagedDetail();
    }//GEN-LAST:event_lablelDamageNotificationMouseClicked
    ...
    private javax.swing.JPanel lablelDamageNotification;
